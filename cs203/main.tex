...
\subsubsection{IEEE 754 floating point}
...
\begin{itemize}
	...
	\item 8 bits for exponent ($e$)
	      \begin{itemize}
		      ...
		      \item 0 and 255 are reserved for special purpose
	      \end{itemize}
...
\begin{table}[ht]
	...
	\begin{tabular}{|ll|}
		...
		\hline
		Floating Point Number & \textcolor{red}{0}\textcolor{blue}{111 1111 1}010 0000 0000 0000 0000 0000 \\
		In Hex                & 0x7FA00000                                                                 \\
		\hline
	\end{tabular}
\end{table}
